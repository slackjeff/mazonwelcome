...
temp="/home/${USER}/.config/autostart/mazon.desktop"
...
Seja muito bem vindo, abaixo você pode conferir algumas opções para você iniciar no sistema!"           \
    --form  --columns 4                                                                                 \
    --field="<b>Documento</b>!img/documentos.png!Documentação para Iniciar":BTN "xdg-open ${sites[1]} " \
    --field="<b>Site Mazon</b>!img/site.png!Site oficial da Mazon":BTN "xdg-open ${sites[0]}"           \
    --field="<b>BananaPkg</b>!img/bananapkg.png!Documentação do BananaPKG":BTN "xdg-open ${sites[2]}"   \
    --field="<b>Fórum Mazon</b>!img/forum.png!Fórum Oficial":BTN "xdg-open ${sites[3]}"                 \
    --field="<b>Sobre</b>!img/sobre.png!Sobre":BTN "
 yad --width='500'
     --height='100'
     --center
     --undecorated
     --image="img/sobreyad.png"
     --borders=5
     --text-align=left
     --text='
...
<b>Contato:</b> root@slackjeff.com.br'
     --button="Sair":1
"                                                                                                       \
    --field="<b>Doação</b>!img/doe.png!Faça uma doação e ajude o projeto.":BTN  "ls"                    \
    --field="<b>Bate Papo</b>!img/chat.png!Grupo no Telegram":BTN "
 yad --width='500'
     --height='100'
     --center
     --undecorated
...
<b>IRC:</b> Estamos também na freenode #mazonos'
     --button="Sair":1
"                                                                                                       \
    --field="<b>Github</b>!img/github.png!Github do projeto":BTN  "xdg-open ${sites[4]}"                \
    --button="Sair":1

# O autoiniciar deve ser apenas no primeiro boot.
# Após isso eve ser excluido.
if [[ -e "$temp" ]]; then
    rm "$temp"
fi
